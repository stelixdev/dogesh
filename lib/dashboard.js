  ...
  <div class="container">
    ...
    <div class="stats-bar">
      ...
      <div class="stat-card">
        ...
        <div class="value" style="font-size: 0.95rem;">gemini-3.5-flash-lite</div>
        <div style="font-size: 0.72rem; color: var(--text-muted); margin-top: 2px;">Groq (gpt-oss-120b) Fallback</div>
      </div>
      <div class="stat-card">
